...
import { VERSION_LABELS, VERSION_NAMES, UI_THEME } from '../constants';
...
export const TopControls: React.FC<TopControlsProps> = React.memo(({
  config,
  onUpdateConfig,
  hudVisible = true,
  onToggleHud,
...
const PerfSlider = React.memo<PerfSliderProps>(({ label, min, max, step, value, onChange }) => (
  <div
